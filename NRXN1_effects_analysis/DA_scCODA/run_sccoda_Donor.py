...
if __name__ == '__main__':
    ...
    ref_types = ['Cycling Dorsal NEC', 'IPC2', 'CN1']
    for i in range(2,3):
        timepoint = timepoints[i]
        ref_type = ref_types[i]
        # run_sccoda_(df_donor, timepoint, cellclass_ordered, ref_type, suffix = '_cellclass_1')
        run_sccoda_(df_donor, timepoint, cellclass_ordered_v2, ref_type, suffix = '_cellclass_2')
