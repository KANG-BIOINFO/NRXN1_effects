...
#BSUB -J STAR_align_QuantTps_batch1
#BSUB -o STAR_align_QuantTps_batch1.out
#BSUB -e STAR_align_QuantTps_batch1.err
...
foo() {
    ...
    mkdir '/data/aronow/Kang/induced_neuron/ChangHui_RNAseq_fastq/isoform_RSEM/star_align/BAM_transcripts/'$sample
    outputFile='/data/aronow/Kang/induced_neuron/ChangHui_RNAseq_fastq/isoform_RSEM/star_align/BAM_transcripts/'$sample'/'
